    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#password1").change(function () {
                if( $(this).val()=="${sessionScope.user.passWord}"){
                    $("#password1Msg").css("color","green")
                    $("#password1Msg").text("原始密码正确")
                }else{
                    $("#password1Msg").css("color","red")
                    $("#password1Msg").text("原始密码错误")
                }
            })
            //验证新密码
    ...
    <div class="personal-r f-r">
        <div class="personal-right">
            ...
            <div class="data-con">
                ...
                <form action="${pageContext.request.contextPath}/user/updatePersonalData.do" method="post">
                    <div class="dt1">
                    ...
                    <div class="dt1">
                        ...
                        <input type="text" id="userName" name="userName" value="${user.userName}" readonly="true" required/>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1">
                        <p class="dt-p f-l">手机号：</p>
                        <input type="text" id="phone" name="phone" placeholder="请填写手机号" value="${user.phone}" required />
                        <span id="phoneMsg" name="Msg"></span>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1">
                        <p class="dt-p f-l">邮箱：</p>
                        <input type="email" placeholder="请填写邮箱" id="email" name="email" value="${user.email}" required />
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1">
                        <p class="dt-p f-l">原密码：</p>
                        <input type="password" id="password1" placeholder="请填写原始密码" value="" required />
                        <span id="password1Msg" name="Msg"></span>
                        <div style="clear:both;"></div>
                    </div>
                    <div class="dt1 <%--dt4--%>">
                        <p class="dt-p f-l">密码：</p>
                        <input type="password" id="password" name="passWord" placeholder="请填写新密码" value="" required />
                        <span id="passWordMsg" name="Msg"></span>
                        <%--<button>修改密码</button>--%>
                        <div style="clear:both;"></div>
                    </div>
                        <input type="submit" class="btn-pst" value="保存" onclick="return sub()">
