...
<div class="zl-header">
    <div class="zl-hd w1200">
        <p class="hd-p1 f-l">
            Hi!您好，欢迎来到宅客微购，请登录  <a href="${pageContext.request.contextPath}/user/toRegister.do">【免费注册】</a>
        </p>
        <p class="hd-p2 f-r">
            <a href="${pageContext.request.contextPath}/index/toIndex.do">返回首页 (个人中心)</a><span>|</span>
...
<div class="logo-search w1200">
    ...
    <div class="search f-r">
        <%--搜索框符合查询--%>
        <form action="${pageContext.request.contextPath}/product/toSearchProducts.do" method="get">
            <div class="search-info">
                <input type="hidden" name="pageNow" value="1"/>
                <input type="hidden" name="isHot" value="1"/>
                <input type="text" name="pName" placeholder="请输入商品名称" value="${productForPageBean.pName}" />
                <button>搜索</button>
                <div style="clear:both;"></div>
            </div>
        </form>
